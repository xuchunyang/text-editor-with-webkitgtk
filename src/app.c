            ...
            GFile        *file)
{
  ...
  sw = gtk_button_new_with_label ("Cut");
  ...
  box = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 6);
  gtk_container_add (GTK_CONTAINER (button), box);
  sw = gtk_button_new_with_label ("Paste");
  gtk_container_add (GTK_CONTAINER (box), sw);
  gtk_container_add (GTK_CONTAINER (toolbar), GTK_WIDGET (button));
  ...
  box = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 6);
  gtk_container_add (GTK_CONTAINER (button), box);
  sw = gtk_button_new_with_label ("Bold");
  gtk_container_add (GTK_CONTAINER (box), sw);
  gtk_container_add (GTK_CONTAINER (toolbar), GTK_WIDGET (button));
...
bloat_pad_startup (GApplication *application)
{
  ...
  gtk_builder_add_from_string (builder,
                               ...
                               "      <section>"
                               "        <item>"
                               "          <attribute name='label' translatable='yes'>_Insert image</attribute>"
                               ...
                               "        </item>"
                               "        <item>"
                               "          <attribute name='label' translatable='yes'>_Strikethrough</attribute>"
                               "          <attribute name='action'>win.busy</attribute>"
                               "        </item>"
                               "        <item>"
